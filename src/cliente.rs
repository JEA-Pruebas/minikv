...
/// Ejecuta el cliente TCP de minikv.
///
/// Lee operaciones desde `STDIN`, las envía al servidor y muestra la respuesta.
...
/// Imprime un error del cliente siguiendo el formato del protocolo.
